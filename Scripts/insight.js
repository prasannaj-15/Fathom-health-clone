...
let post_data = [
     ...
     },
     {
      ...
      "post_description": "Medical coding quality and accuracy have a massive impact on your organization’s bottom line and revenue cycle. Whether that means gaining quick, regu..."
     },
     {
    ...
    let post_data2 = [
        {
           ...
           {
            "post_image": "https://blog.fathomhealth.com/hubfs/fathom-inflect-vituity.jpg",
            "post_image_url": "https://blog.fathomhealth.com/the-secret-to-increasing-medical-coding-accuracy",
            "post_type": "PRESS RELEASE",
            "post_type_url": "https://blog.fathomhealth.com/tag/industry-news",
            "post_headline": "Fathom secures investment from Vituity’s Inflect Health",
            "post_headline_url": "https://blog.fathomhealth.com/the-secret-to-increasing-medical-coding-accuracy",
            "post_description": "SAN FRANCISCO, CA — Fathom, the leader in AI medical coding automation, announced it received a strategic investment from Inflect Health, the innovati..."
           },
           {
            "post_image": "https://blog.fathomhealth.com/hubfs/ways.jpg",
            "post_image_url": "https://blog.fathomhealth.com/the-secret-to-increasing-medical-coding-accuracy",
            "post_type": "INDUSTRY NEWS",
            "post_type_url": "https://blog.fathomhealth.com/tag/industry-news",
            "post_headline": "5 ways medical coding accuracy impacts your revenue cycle",
            "post_headline_url": "https://blog.fathomhealth.com/the-secret-to-increasing-medical-coding-accuracy",
            "post_description": "Creating a healthy and stable revenue cycle is critical for medical organizations of all shapes and sizes. Medical practices and health systems benefi..."
           },
           {
            "post_image": "https://blog.fathomhealth.com/hubfs/andy-kelly-0E_vhMVqL9g-unsplash.jpg",
            "post_image_url": "https://blog.fathomhealth.com/the-secret-to-increasing-medical-coding-accuracy",
            "post_type": "ARTIFICIAL INTELLIGENCE",
            "post_type_url": "https://blog.fathomhealth.com/tag/industry-news",
            "post_headline": "Artificial intelligence vs. robotic process automation",
            "post_headline_url": "https://blog.fathomhealth.com/the-secret-to-increasing-medical-coding-accuracy",
            "post_description": "Let’s face it: Healthcare is, in many ways, still an old-fashioned industry. Many patient charts are still housed on paper and stored in manila folder..."
           },
           {
            "post_image": "https://blog.fathomhealth.com/hubfs/derek-thomson-NqJYQ3m_rVA-unsplash.jpg",
            "post_image_url": "https://blog.fathomhealth.com/the-secret-to-increasing-medical-coding-accuracy",
            "post_type": "AUTOMATION",
            "post_type_url": "https://blog.fathomhealth.com/tag/industry-news",
            "post_headline": "Six ways AI can maximize your revenue cycle",
            "post_headline_url": "https://blog.fathomhealth.com/the-secret-to-increasing-medical-coding-accuracy",
            "post_description": "With the advent of artificial intelligence technology and its application in solving some of the most complex challenges of companies and industries a..."
           }
       ];
...
function filterData(num){
    ...
    let data = post_data2.forEach((el)=>{
        if(el.post_type===num){
            arr.push(el);
        } 
    });
...
document.querySelector(`.sub-mid-header`).addEventListener(`click`,firstPost);


function firstPost(){

    window.location.href = `${post_data[0].post_headline_url}`
